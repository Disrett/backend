...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.getProfile = function (username) {
            return this.users.findByUsername(username);
        };
        // POST /api/users/:id/follow  (protégée)
        UsersController_1.prototype.follow = function (me, targetId) {
            return this.users.follow(me.id, targetId);
        };
        // DELETE /api/users/:id/follow  (protégée)
        UsersController_1.prototype.unfollow = function (me, targetId) {
    ...
    (function () {
        ...
        _getProfile_decorators = [(0, common_1.Get)(':username')];
        _follow_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)(':id/follow')];
        _unfollow_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Delete)(':id/follow')];
