...
var NotificationsService = function () {
    ...
    var NotificationsService = _classThis = /** @class */ (function () {
        ...
        NotificationsService_1.prototype.create = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.notification.create({ data: params })];
                });
            });
        };
        /** Notifications d'un utilisateur, non lues d'abord. */
        NotificationsService_1.prototype.list = function (recipientId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        NotificationsService_1.prototype.markAllRead = function (recipientId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.notification.updateMany({
                            where: { recipientId: recipientId, read: false },
                            data: { read: true },
                        })];
                });
            });
        };
        NotificationsService_1.prototype.remove = function (recipientId, id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.notification.deleteMany({ where: { id: id, recipientId: recipientId } })];
                });
            });
        };
