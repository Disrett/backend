...
var NotificationsController = function () {
    ...
    var NotificationsController = _classThis = /** @class */ (function () {
        ...
        NotificationsController_1.prototype.list = function (me) {
            return this.notifications.list(me.id);
        };
        // PATCH /api/notifications/read-all
        NotificationsController_1.prototype.readAll = function (me) {
            return this.notifications.markAllRead(me.id);
        };
        // DELETE /api/notifications/:id
        NotificationsController_1.prototype.remove = function (me, id) {
